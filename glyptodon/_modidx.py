...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'glyptodon.annotation': { 'glyptodon.annotation.createAnnotationFigure': ( 'annotation.html#createannotationfigure',
                                      ...
                                      'glyptodon.annotation.createPageSelector': ( 'annotation.html#createpageselector',
                                                                                   'glyptodon/annotation.py')},
            'glyptodon.app': { 'glyptodon.app.createFigureList': ('app.html#createfigurelist', 'glyptodon/app.py'),
                               'glyptodon.app.method': ('app.html#method', 'glyptodon/app.py'),
                               'glyptodon.app.renderContent': ('app.html#rendercontent', 'glyptodon/app.py'),
            ...
            'glyptodon.classes': { 'glyptodon.classes.BBox': ('classes.html#bbox', 'glyptodon/classes.py'),
                                   ...
                                   'glyptodon.classes.BBox.csvToLines': ('classes.html#bbox.csvtolines', 'glyptodon/classes.py'),
